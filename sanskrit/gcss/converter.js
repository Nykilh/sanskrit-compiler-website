...
function print_many_words0(index_pmw)
{
  var text_pmw = many_words(document.getElementsByName('many_words_text0')[0].value);
  ...
  document.getElementsByName('converted_text0')[0].value = ans;
...
function print_many_words1(index_pmw)
{
  var text_pmw = many_words(document.getElementsByName('many_words_text1')[0].value);
  ...
  document.getElementsByName('converted_text1')[0].value = ans;
...
function print_many_words2(index_pmw)
{
  var text_pmw = many_words(document.getElementsByName('many_words_text2')[0].value);
  ...
  document.getElementsByName('converted_text2')[0].value = ans;
...
function print_many_words3(index_pmw)
{
  var text_pmw = many_words(document.getElementsByName('many_words_text3')[0].value);
  ...
  document.getElementsByName('converted_text3')[0].value = ans;
